const videos = [
	{
			...
			"product": {
					...
					"summary": "The Coleman Atlantis SaluSpa is made with TriTech 3-ply inflated walls that provide it with an extra layer of durability and comfort. It can reach temperatures up 104 degrees F, so you can have a soothing and relaxing experience on cooler days. The integrated water filtration system further ensures that the hot tub always remains clean and hygienic. There are also two easy-lift handles on the side that make it incredibly easy to move around.",
					"pros": [
					...
					"review": "I've had the spa for about 4 weeks and I'm loving it.  I've had larger fiberglass hot tubs in the past and I enjoy this model just as much.  So easy to set up.  Mine arrived mid-afternoon and I was sitting in 104 degree water the next evening.  Portability is a plus.  In a few weeks I'm going to drain it, and set up in the basement rec room for winter use.  I like this square model, which provides a little more leg room than a similarly sized round model.  One drawback is the clunky timer function.  You cannot set up on a weekly schedule...you can only set it for one occurrence.  Consequently, I don't use the timer.  I set the spa for 102 and let the thermostat determine when it should run.  My temp varies between 100 to 104, staying at 102 most of the time.",
					"faq": {
							"answer": "Yes. This portable hot tub can run with or without the heater turned on, so you can use it to cool off on hot days!",
